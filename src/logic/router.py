...
def a_star_search(user_coords, dest_coords, all_stops):
    ...
    while queue:
        ...
        nodes_visited += 1                                                                                        # 1. LẤY NODE CÓ f(x) NHỎ NHẤT RA KHỎI HÀNG ĐỢI ĐỂ XỬ LÍ
    ...
    # === III. KẾT THÚC: TÍNH THỜI GIAN VÀ TRẢ VỀ ===
    execution_time = time.time() - start_time
    
    # Gắn thêm các chỉ số hiệu suất vào từng kết quả để truyền ra app.py
    for res in results:
